 ...
 * FileName: GeneratorCode
 * Author:   shibun
 * Date:     2019/2/26 22:25
 * Description: mybatis_plus的代码生成器
 * History:
...
public class GeneratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return rb.getString("OutputDirXml")+ "/ka/shibun/xinyuan/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
